...
internal class ROS2ForUnity
{
    ...
    private static string ros2ForUnityAssetFolderName = "Plugins/ROS";
    ...
    public static Platform GetOS()
    {
        ...
        throw new System.NotSupportedException("Only Linux and Mac and Windows are supported");
    }
    ...
    private void LoadMetadata() 
    {
        ...
        try
        {
            ros2csMetadata.Load(Path.Join( Application.streamingAssetsPath,"metadata_ros2cs.xml"));
            ros2ForUnityMetadata.Load(Path.Join( Application.streamingAssetsPath,"metadata_ros2_for_unity.xml"));
        }
