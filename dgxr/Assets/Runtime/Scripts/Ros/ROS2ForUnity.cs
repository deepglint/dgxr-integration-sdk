...
internal class ROS2ForUnity
{
    ...
    private static string ros2ForUnityAssetFolderName = "Runtime";
    ...
    private void LoadMetadata() 
    {
        ...
        try
        {
            ...
            ros2ForUnityMetadata.Load(GetRos2ForUnityPath()+separator+"Scripts"+separator + "Ros" + separator + "metadata_ros2_for_unity.xml");
        }
