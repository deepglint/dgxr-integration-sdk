...
namespace Deepglint.XR.Toolkit.RoamStick.Core
{
    ...
    public class KCharacterSystem : MonoBehaviour
    {
        ...
        /// </summary>
        public static void RegisterCharacterMotor(KCharacterMotor motor)
        {
        ...
        /// </summary>
        public static void UnregisterCharacterMotor(KCharacterMotor motor)
        {
        ...
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            {
                KCharacterMotor motor = CharacterMotors[i];
        ...
        /// </summary>
        public static void Simulate(float deltaTime, List<KCharacterMotor> motors, List<PhysicsMover> movers)
        {
...
#pragma warning disable 0162
            ...
            for (int i = 0; i < characterMotorsCount; i++)
            {
                KCharacterMotor motor = motors[i];
