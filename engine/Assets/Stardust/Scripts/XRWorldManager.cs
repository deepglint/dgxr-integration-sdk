...
namespace DGXR
{
    public class XRWorldManager : MonoBehaviour
    {
        ...
        {
            SetScale();
            SetHead(_head.transform.position);
        }
        ...
        public void SetCamera(Vector3 _cameraPos)
        {
            transform.localPosition = new Vector3(transform.localPosition.x, _cameraPos.y, _cameraPos.z);
            centerViewPoint = new Vector3(transform.localPosition.x, _cameraPos.y, _cameraPos.z);
        }
        ...
        private void SetHeadPosition(Vector3 _headPos)
        {
            ...
            MDebug.LogTest("_headPos: " + _headPos.ToString());
        ...
        public Vector3 GetHeadPosition(bool isHeadPos)
        {
            if (isHeadPos)
            {
